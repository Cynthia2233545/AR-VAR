...
if __name__ == "__main__":
    ...
    parser.add_argument('--vae_ckpt',default='/data/tangyingxin/CAR-main/vae_ch160v4096z32.pth', type=str, help='path to the pre-trained vae checkpoint')
    parser.add_argument('--var_ckpt',default='/data/tangyingxin/CAR-main/var_d16.pth', type=str, help='path to the pre-trained var checkpoint')
    parser.add_argument('--car_ckpt',default='/data/tangyingxin/CAR-main/local_output_hed_new_lr0.001/car_ckpt_best.pth',type=str, help='path to the car checkpoint')
    
    parser.add_argument('--img_path', type=str, help='path to an original image from which the condition is extracted')
    parser.add_argument('--save_path',default='/data/tangyingxin/CAR-main/local_output_hed_new_lr0.001/infrence_result/test.png', type=str, help='path to the generated image')
    
    parser.add_argument('--cls', default=0,type=int, help='an index ranging from 0 to 999 in the ImageNet label set')
