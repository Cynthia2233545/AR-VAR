...
def build_everything(args: arg_util.Args):
    ...
    print('vae_localvae_localvae_localvae_localvae_localvae_local')
    ...
    for ep in range(start_ep, args.ep):
        ...
        # if is_val_and_also_saving:
            ...
            if dist.is_local_master():
                ...
                # 保存完整的 CAR 模型权重（包括新增模块）
                torch.save(trainer.car_wo_ddp.state_dict(), local_out_car_ckpt_last)
...
def train_one_ep(ep: int, is_first_ep: bool, start_it: int, args: arg_util.Args,
    ...
    # 使用unet_feature替代dino_target
    for it, (inp, control_tensors, label, unet_feature) in me.log_every(start_it, iters_train, ld_or_itrt, 30 if iters_train > 8000 else 5, header):
        ...
        # 将UNet特征转移到设备
        unet_feature = unet_feature.to(args.device, non_blocking=True)
