...
class Args(Tap):
    data_path: str = "/data/tangyingxin/CAR/Low_does_Dataset"
    condition_path: str = "/data/tangyingxin/CAR/Low_does_Dataset/train_condition"
    vae_ckpt: str = "vae_ch160v4096z32.pth"
    pretrained_var_ckpt: str = "var_d16.pth"
